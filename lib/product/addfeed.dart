...
class AddFeed extends StatefulWidget {
  final String email;
  final User user;
  const AddFeed({Key key, this.email, this.user}) : super(key: key);
  @override
...
class _AddFeedState extends State<AddFeed> {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Click here to input your description!',
  ...
  void _postDialog() {
    if (_image == null || _descCtrl.text.toString() == "") {
      Fluttertoast.showToast(
          msg: "Image/Description is empty!",
  ...
  Future<void> _postFeed() async {
    ...
    String desc_review = _descCtrl.text.toString();
    print(desc_review);

    http.post(
        Uri.parse(
            "https://nurulida1.com/272834/bergedillovers/php/newpost.php"),
        body: {
          "email": "irdinazulkeffli@gmail.com",
      ...
      if (response.body == "success") {
        Fluttertoast.showToast(
            msg: "Post has been posted on feed.",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.TOP,
